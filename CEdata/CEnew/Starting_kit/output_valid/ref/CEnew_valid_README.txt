...
CEnew_valid_solution.csv: Validation data {A, B} target values

This sample data contains only a few examples for debug purposes. The format is identical to what is used on the Codalab server.
